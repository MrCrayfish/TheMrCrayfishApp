...
public class TaskFetchVideos extends AsyncTask<String, Integer, ArrayList<VideoItem>>
{
	...
	public TaskFetchVideos(VideosActivity activity)
	{
	...
	protected ArrayList<VideoItem> doInBackground(String... params)
	{
		try
		{
			...
			HttpGet request = new HttpGet("http://gdata.youtube.com/feeds/api/playlists/" + params[0] + "?v=2&alt=jsonc&max-results=5&prettyprint=true");
