...
public class VideoMenuActivity extends Activity implements IMenu
{
	...
	public ArrayList<MenuItem> getItems()
	{
		...
		items.add(new MenuItem("Latest Uploads", "Discover MrCrayfish's newest videos", R.drawable.camera, videoIntent));
		items.add(new MenuItem("Playlists", "Collections of Videos", R.drawable.paper, this, PlaylistActivity.class));
		items.add(new MenuItem("Watch Later", "Your saved videos", R.drawable.ic_save, this, SavedVideosActivity.class));
		items.add(new MenuItem("View Channel", "Go to MrCrayfish's Channel", R.drawable.socialmedia, YouTubeUtil.openChannel(this, "mrcrayfishminecraft")));
		...
		items.add(new MenuItem("Cray Selects", "A selection of MrCrayfish's favourites", R.drawable.ic_star, selectsIntent));
		return items;
	}
